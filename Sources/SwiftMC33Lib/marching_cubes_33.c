...
#include "./include/MC33_LookUpTable.h"
...
static inline unsigned int signbf(float x) {
			...
			if (p[c] == FF) {
					...
					if (z || x)
						...
						if (v[0] == 0) {
							...
							if (p[1] != FF)
								...
								p[0] = MC33_surfint(M,0,y + 1,0,u.r);
						} else {
							t = v[0]/(v[0] - v[1]);
							u.r[0] = u.r[2] = 0;
							u.r[1] = y + t;
					...
					if (x)
						...
						if (v[1] == 0) {
							if (p[0] != FF)
								...
								p[1] = M->Lz[y + 1][0]; // value of previous slice
							else
							...
							if (p[10] != FF)
								...
								p[1] = MC33_surfint(M, 0, y + 1, z + 1, u.r);
						} else {
							t = v[1]/(v[1] - v[2]);
							u.r[0] = 0; u.r[1] = y + 1;
							u.r[2] = z + t;
					...
					if (x)
						...
						if (v[3] == 0) {
							...
							if (p[10] != FF)
								...
								p[2] = MC33_surfint(M,0,y + 1,z + 1,u.r);
						} else {
							t = v[3]/(v[3] - v[2]);
							u.r[0] = 0; u.r[2] = z + 1;
							u.r[1] = y + t;
					...
					if (y || x)
						...
						if (v[0] == 0) {
							if (p[0] != FF)
								...
								p[3] = M->Lz[0][0]; // value of previous slice
							else
							...
							if (p[2] != FF)
								...
								p[3] = MC33_surfint(M,0,0,z + 1,u.r);
						} else {
							t = v[0]/(v[0] - v[3]);
							u.r[0] = u.r[1] = 0;
							u.r[2] = z + t;
					...
					if (z)
						...
						if (v[4] == 0) {
							...
							if (p[5] != FF)
								...
								p[4] = MC33_surfint(M,x + 1,y + 1,0,u.r);
						} else {
							t = v[4]/(v[4] - v[5]);
							u.r[0] = x + 1; u.r[2] = 0;
							u.r[1] = y + t;
					...
					if (y)
						...
						if (v[4] == 0) {
							if (p[8] != FF)
								...
								p[7] = M->Lz[0][x + 1]; // value of previous slice
							else
							...
							if (p[6] != FF)
								...
								p[7] = MC33_surfint(M,x + 1,0,z + 1,u.r);
						} else {
							t = v[4]/(v[4] - v[7]);
							u.r[0] = x + 1; u.r[1] = 0;
							u.r[2] = z + t;
					...
					if (z || y)
						...
						if (v[0] == 0) {
							...
							if (p[4] != FF)
								...
								p[8] = MC33_surfint(M,x + 1,0,0,u.r);
						} else {
							t = v[0]/(v[0] - v[4]);
							u.r[1] = u.r[2] = 0;
							u.r[0] = x + t;
					...
					if (z)
						...
						if (v[1] == 0) {
							...
							if (p[5] != FF)
								...
								p[9] = MC33_surfint(M,x + 1,y + 1,0,u.r);
						} else {
							t = v[1]/(v[1] - v[5]);
							u.r[1] = y + 1; u.r[2] = 0;
							u.r[0] = x + t;
				...
				case 10:
					if (v[2] == 0) {
						...
						if (p[5] == FF)
							p[10] = (p[6] == FF? MC33_surfint(M,x + 1,y + 1,z + 1,u.r): p[6]);
						else
							p[10] = p[5];
					} else {
						t = v[2]/(v[2] - v[6]);
					...
					if (y)
						...
						if (v[3] == 0) {
							...
							if (p[6] != FF)
								...
								p[11] = MC33_surfint(M,x + 1,0,z + 1,u.r);
						} else {
							t = v[3]/(v[3] - v[7]);
							u.r[1] = 0; u.r[2] = z + 1;
							u.r[0] = x + t;
